...
int main() {
  ...
  // process and print min and max elements
  std::cout << "minimum: " << *std::min_element(coll.cbegin(), coll.cend()) << std::endl;
  std::cout << "maximum: " << *std::max_element(coll.cbegin(), coll.cend()) << std::endl;
  ...
  std::cout << "minimum of absolute values: " 
    << *std::min_element(coll.cbegin(), coll.cend(), absLess) << std::endl;
  std::cout << "maximum of absolute values: "
    << *std::max_element(coll.cbegin(), coll.cend(), absLess) << std::endl;
}
